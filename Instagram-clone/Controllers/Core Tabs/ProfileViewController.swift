...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate {
    func profileHeaderDidTapPostsButton(_: ProfileInfoHeaderCollectionReusableView) {
        collectionView?.scrollToItem(at: IndexPath(row: 0, section: 1), at: .top, animated: true)
    }

    func profileHeaderDidTapFollowersButton(_: ProfileInfoHeaderCollectionReusableView) {
    ...
    func profileHeaderDidTapFollowingButton(_: ProfileInfoHeaderCollectionReusableView) {
        let vc = ListViewController()
        vc.title = "Following"
        vc.navigationItem.largeTitleDisplayMode = .never
        navigationController?.pushViewController(vc, animated: true)
    ...
    func profileHeaderDidTapEditProfileButton(_: ProfileInfoHeaderCollectionReusableView) {
